    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text('Small Lessons, Big Impacts', textAlign: TextAlign.center, style: TextStyle(color: Color(0xffE2E2E2), fontFamily: 'popSBold', fontSize: 29.0),),
            Padding(
                    padding: EdgeInsets.fromLTRB(44, 10, 44, 30),
                    child: Text('With eiweiwjew, you can take control of your SAT score and increase it in a smarter way.', textAlign: TextAlign.center, style: TextStyle(color: Color.fromRGBO(226, 226, 226, 0.65), fontFamily: 'popMed', fontSize: 15.0),),
                  ),
            Container(
